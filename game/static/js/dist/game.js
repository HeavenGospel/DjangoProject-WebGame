...
class ChatField {
   ...
   add_listening_events() {
    ...
    show_history() {
        ...
        if (this.func_id) clearTimeout(this.func_id);  // 删掉计时函数
    ...
    add_listening_events() {
        ...
        this.playground.game_map.$canvas.mousedown(function(e) {
            ...
            if (e.which === 3) {
                ...
                } else if(outer.cur_skill === "blink") {  // f
...
//-----------------------------------------------------------------
        ...
        this.ctx.stroke();
        this.ctx.clip();
        this.ctx.drawImage(this.blink_img, (x - r) * scale, (y - r) * scale, r * 2 * scale, r * 2 * scale);  // 画技能图案
        this.ctx.restore();
    ...
    on_destroy() {
        if(this.character === "me")
        this.playground.state = "over";  // 死亡后更新状态
...
class MultiPlayerSocket {
    ...
    receive_message(uuid, text) {
        ...
        if(player) {
            ...
            player.playground.chat_field.add_message('泉水指挥官', text);
        }
    }
}
class  AcGamePlayground {
    ...
    get_random_color() {
        let colors = ["blue", "red", "pink", "yellow", "green", "grey", "purple"];
...
`);
    ...
    acwing_login() {
        $.ajax({
            url: "https://app2229.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() {  // 在远程服务器上登录
        ...
        $.ajax({
            url: "https://app2229.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    register_on_remote() {  // 在远程服务器上注册
        ...
        $.ajax({
            url: "https://app2229.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() {  // 在远程服务器上登出
        if (this.platform === "ACAPP") {
            ...
            $.ajax({
                url: "https://app2229.acapp.acwing.com.cn/settings/logout/",
                type: "GET",
                success: function(resp) {
                    if (resp.result === "success") {
                        location.reload();  // 刷新页面
    ...
    getinfo_acapp() {
        ...
        $.ajax({
            url: "https://app2229.acapp.acwing.com.cn/settings/acwing/acapp/apply_code",
            type: "GET",
            success: function(resp) {
                if (resp.result === "success") {
    ...
    getinfo_web() {
        ...
        $.ajax({
            url: "https://app2229.acapp.acwing.com.cn/settings/getinfo/",
            type: "GET",
            data: {
